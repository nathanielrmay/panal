...
# ==========================================
TARGET_SCHEMA  <- "nba"
TARGET_TABLE   <- "nba_teams"
source("../db_config.R")

# ==========================================
# 1. FETCH DATA
# ==========================================
print("Fetching NBA Teams (hoopR::nba_teams)...")

# nba_teams() usually doesn't require arguments, fetches current
df <- hoopR::nba_teams()

# Convert to standard data frame
df <- as.data.frame(df)

print(paste("Fetched", nrow(df), "teams."))
