...
# 1. FETCH DATA
# ==========================================
print(paste("Fetching NBA Schedule for season:", SEASON))
...
print(paste("Fetched", nrow(df), "schedule entries."))
...
tryCatch({
  ...
  dbExecute(con, "REFRESH MATERIALIZED VIEW nba.schedule")
  print("Success: Materialized view nba.schedule refreshed.")
}, error = function(e) {
